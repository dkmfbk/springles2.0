...
class TestInferencer extends AbstractInferencer
{

    private static final Logger LOGGER = LoggerFactory.getLogger(TestInferencer.class);
    ...
    public TestInferencer(final Ruleset ruleset, @Nullable final BindingSet rulesetBindings,
                ...
                throws QueryEvaluationException, RepositoryException
        {
            while (true) {
                ...
                synchronized (this) {
                    ...
                    rule = TestInferencer.this.ruleset.getRule(ruleID);
                }
