...
public final class CopyOfSparqlRenderer
{
    ...
    private CopyOfSparqlRenderer(final Iterable<? extends QueryModelNode> nodes,
    ...
    public static CopyOfSparqlRenderer render(final Value value)
    {
        Preconditions.checkNotNull(value);
        return new CopyOfSparqlRenderer(Collections.singleton(new ValueConstant(value)),
                Collections.<Dataset>singleton(null), false);
    }

    public static CopyOfSparqlRenderer render(final QueryModelNode node)
    {
        Preconditions.checkNotNull(node);
        return new CopyOfSparqlRenderer(Collections.singleton(node),
                Collections.<Dataset>singleton(null), false);
    }

    public static CopyOfSparqlRenderer render(final TupleExpr query, @Nullable final Dataset dataset)
    {
        Preconditions.checkNotNull(query);
        return new CopyOfSparqlRenderer(Collections.singleton(query), Collections.singleton(dataset),
                true);
    }

    public static CopyOfSparqlRenderer render(final UpdateExpr update, @Nullable final Dataset dataset)
    {
        Preconditions.checkNotNull(update);
        return new CopyOfSparqlRenderer(Collections.singleton(update), Collections.singleton(dataset),
                true);
    }

    public static CopyOfSparqlRenderer render(final Iterable<? extends UpdateExpr> updates,
            final Iterable<? extends Dataset> datasets)
    {
        Preconditions.checkNotNull(updates);
        Preconditions.checkNotNull(datasets);
        return new CopyOfSparqlRenderer(updates, datasets, true);
    }

    public CopyOfSparqlRenderer withBaseURI(final String baseURI)
    {
        this.baseURI = baseURI;
        return this;
    }

    public CopyOfSparqlRenderer withPrefixes(final Map<String, String> prefixes)
    {
    ...
    public CopyOfSparqlRenderer withNamespaces(final Map<String, String> namespaces)
    {
    ...
    public CopyOfSparqlRenderer withIndentString(final String indentString)
    {
    ...
    public CopyOfSparqlRenderer withLinePrefix(final String linePrefix)
    {
    ...
    public CopyOfSparqlRenderer withHeader(final boolean headerRendered)
    {
        this.headerRendered = headerRendered;
        return this;
    }
    ...
    private CopyOfSparqlRenderer emit(final String string)
    {
        this.builder.append(string);
        return this;
    }

    private CopyOfSparqlRenderer emitIf(final boolean condition, final String string)
    {
        if (condition) {
            this.builder.append(string);
        }
    ...
    private CopyOfSparqlRenderer emitEscaped(final String label)
    {
    ...
    private CopyOfSparqlRenderer emitValue(final Value value)
    {
    ...
    private CopyOfSparqlRenderer newline()
    {
        emit("\n");
        emit(this.linePrefix);
    ...
    private CopyOfSparqlRenderer openBrace()
    {
        emit("{");
        ++this.indentLevel;
        newline();
    ...
    private CopyOfSparqlRenderer closeBrace()
    {
        --this.indentLevel;
        newline();
        emit("}");
    ...
    private CopyOfSparqlRenderer renderingFailed(final String message, final QueryModelNode node)
    {
    ...
    private CopyOfSparqlRenderer emitHeader()
    {
    ...
    private CopyOfSparqlRenderer emitNode(final QueryModelNode node)
    {
    ...
    private CopyOfSparqlRenderer emitUpdateExpr(final UpdateExpr node)
    {
    ...
    private CopyOfSparqlRenderer emitDatasetAsComment(final boolean readPart, final boolean writePart)
    {
        if (this.currentDataset != null) {
            if (readPart) {
                for (final URI uri : this.currentDataset.getDefaultGraphs()) {
    ...
    private CopyOfSparqlRenderer emitUpdateArg(final ValueExpr graphExpr,
    ...
    private CopyOfSparqlRenderer emitTupleExpr(final TupleExpr node)
    {
        if (node instanceof QueryRoot) {
            ...
            renderingFailed("Unsupported node: ", node);
        }
        return this;
    }
    ...
    private CopyOfSparqlRenderer emitQuery(final SparqlQuery query)
    {
    ...
    private CopyOfSparqlRenderer emitProjectionElems(final Iterable<? extends ProjectionElem> elems)
    {
        boolean first = true;
    ...
    private CopyOfSparqlRenderer emitOrderElems(final Iterable<? extends OrderElem> elems)
    {
        boolean first = true;
    ...
    private CopyOfSparqlRenderer emitStatementPattern(final StatementPattern node)
    {
    ...
    private CopyOfSparqlRenderer emitUnaryTupleOperator(final UnaryTupleOperator node)
    {
    ...
    private CopyOfSparqlRenderer emitBinaryTupleOperator(final BinaryTupleOperator node)
    {
        if (node instanceof Join) {
    ...
    private CopyOfSparqlRenderer emitBindingSetAssignment(final BindingSetAssignment node)
    {
    ...
    private CopyOfSparqlRenderer emitPropertyPath(final TupleExpr node, final Var start, final Var end)
    {
    ...
    private CopyOfSparqlRenderer emitValueExpr(final ValueExpr node)
    {
    ...
    private CopyOfSparqlRenderer emitUnaryValueOperator(final UnaryValueOperator node)
    {
        if (node instanceof Not) {
            ...
            return renderingFailed("Unsupported node: ", node);
        }
    }

    private CopyOfSparqlRenderer emitBinaryValueOperator(final BinaryValueOperator node)
    {
    ...
    private CopyOfSparqlRenderer emitFunction(final String functionName,
